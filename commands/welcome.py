...
def setup(bot: discord.Bot):
    ...
    async def welcome_cmd(
        ...
        channel: discord.Option(discord.TextChannel, "The channel to send the messages in."),
        mentions: discord.Option(bool, "Mentions every members in the messages if true"),
        welcome_message: discord.Option(str, "The welcome message", required=False, default=None),
    ):
